...
const SAMPLE_UNITS: SampleUnit[] = [
...
];
  {
    ...
    yearLevel: "Foundation",
    subject: "HASS",
    description: "8-week civics unit for Foundation students exploring rules, sharing, and being a good citizen. Students learn about classroom rules, sharing fairly, and how we all belong to a community.",
    url: "/units/hass-civics-F.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "hass-civics-Y1",
    title: "Civics and Citizenship — Year 1",
    yearLevel: "Year 1",
    subject: "HASS",
    description: "8-week civics unit on being a good citizen at home, school and in the community. Students explore rights, responsibilities, voting, and how groups make decisions fairly.",
    url: "/units/hass-civics-Y1.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "hass-civics-Y2",
    title: "Civics and Citizenship — Year 2",
    yearLevel: "Year 2",
    subject: "HASS",
    description: "8-week civics unit on local communities, leaders, and how rules help us. Students investigate school and local council, and how people participate in community decisions.",
    url: "/units/hass-civics-Y2.html",
    weeks: 8,
    lessons: 24,
  },
  {
    ...
    yearLevel: "Year 5",
    subject: "HASS",
    description: "8-week history unit on the Australian Constitution, federation, and democratic principles. Students investigate how Australia became a nation and the principles that guide our democracy.",
    url: "/units/hass-history-Y5.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "hass-history-Y6",
    title: "History — Year 6",
    yearLevel: "Year 6",
    subject: "HASS",
    description: "8-week history unit on Australia in the global context — World War I, World War II, and contemporary Australia. Students explore Australia's role in global events and its evolving identity.",
    url: "/units/hass-history-Y6.html",
    weeks: 8,
    lessons: 24,
  },

  {
    id: "narrative-writing-Y1",
    title: "Narrative Writing — Year 1",
    yearLevel: "Year 1",
    subject: "English",
    description: "8-week narrative writing unit using The Snowman as mentor text. Students plan, draft, revise and publish imaginative stories with a clear structure, characters and setting.",
    url: "/units/narrative-writing-Y1.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "narrative-writing-Y2",
    title: "Narrative Writing — Year 2",
    yearLevel: "Year 2",
    subject: "English",
    description: "8-week narrative writing unit using The Twits as mentor text. Students explore character development, dialogue, and story structure through Roald Dahl's hilarious text.",
    url: "/units/narrative-writing-Y2.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "narrative-writing-Y5",
    title: "Narrative Writing — Year 5",
    yearLevel: "Year 5",
    subject: "English",
    description: "8-week narrative writing unit using Bridge to Terabithia as mentor text. Students develop sophisticated narrative techniques including symbolism, voice, and thematic depth.",
    url: "/units/narrative-writing-Y5.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "narrative-writing-Y6",
    title: "Narrative Writing — Year 6",
    yearLevel: "Year 6",
    subject: "English",
    description: "8-week narrative writing unit using The Giver as mentor text. Students explore dystopian narrative conventions, complex themes, and crafted prose style through Lowry's classic.",
    url: "/units/narrative-writing-Y6.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "persuasive-writing-Y1",
    title: "Persuasive Writing — Year 1",
    yearLevel: "Year 1",
    subject: "English",
    description: "8-week persuasive writing unit using We Want Our Books as mentor text. Students learn to express opinions, give reasons, and write simple persuasive texts about things they care about.",
    url: "/units/persuasive-writing-Y1.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "persuasive-writing-Y2",
    title: "Persuasive Writing — Year 2",
    yearLevel: "Year 2",
    subject: "English",
    description: "8-week persuasive writing unit using I Wanna Iguana as mentor text. Students explore persuasive techniques through letter writing, building arguments with reasons and examples.",
    url: "/units/persuasive-writing-Y2.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "persuasive-writing-Y5",
    title: "Persuasive Writing — Year 5",
    yearLevel: "Year 5",
    subject: "English",
    description: "8-week persuasive writing unit using The Boy in the Striped Pyjamas as mentor text. Students develop sophisticated persuasive techniques for essays and speeches on social justice themes.",
    url: "/units/persuasive-writing-Y5.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "persuasive-writing-Y6",
    title: "Persuasive Writing — Year 6",
    yearLevel: "Year 6",
    subject: "English",
    description: "8-week persuasive writing unit using The Hate U Give as mentor text. Students write powerful persuasive pieces on equity, justice, and community — applying critical literacy skills.",
    url: "/units/persuasive-writing-Y6.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "informative-writing-Y1",
    title: "Informative Writing — Year 1",
    yearLevel: "Year 1",
    subject: "English",
    description: "8-week informative writing unit exploring facts about animals, habitats and the natural world. Students write simple information reports using National Geographic Kids as a model.",
    url: "/units/informative-writing-Y1.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "informative-writing-Y2",
    title: "Informative Writing — Year 2",
    yearLevel: "Year 2",
    subject: "English",
    description: "8-week informative writing unit using Emu's by Graeme Base as mentor text. Students explore the features of information reports through Australia's unique wildlife.",
    url: "/units/informative-writing-Y2.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "informative-writing-Y5",
    title: "Informative Writing — Year 5",
    yearLevel: "Year 5",
    subject: "English",
    description: "8-week informative writing unit using The Boy Who Harnessed the Wind as mentor text. Students research and write detailed information reports on renewable energy, sustainability and innovation.",
    url: "/units/informative-writing-Y5.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "informative-writing-Y6",
    title: "Informative Writing — Year 6",
    yearLevel: "Year 6",
    subject: "English",
    description: "8-week informative writing unit using A Long Walk to Water as mentor text. Students write substantial information reports on global issues, integrating research, data and narrative elements.",
    url: "/units/informative-writing-Y6.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "maths-geometry-Y3",
    title: "Geometry — Year 3",
    yearLevel: "Year 3",
    subject: "Mathematics",
    description: "8-week geometry unit on angles, parallel and perpendicular lines. Students identify, compare and construct angles, explore the properties of 2D shapes, and describe lines in the environment.",
    url: "/units/maths-geometry-Y3.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "maths-geometry-Y4",
    title: "Geometry — Year 4",
    yearLevel: "Year 4",
    subject: "Mathematics",
    description: "8-week geometry unit on 3D objects, prisms, pyramids and symmetry. Students compare 2D and 3D shapes, explore symmetry in the environment, and build geometric reasoning.",
    url: "/units/maths-geometry-Y4.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "science-earth-Y4",
    title: "Earth Sciences — Year 4",
    yearLevel: "Year 4",
    subject: "Science",
    description: "8-week earth sciences unit on Earth's resources, fossils, and geological timescales. Students investigate rocks, minerals, the fossil record, and how Earth's surface has changed over time.",
    url: "/units/science-earth-Y4.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "science-earth-Y5",
    title: "Earth Sciences — Year 5",
    yearLevel: "Year 5",
    subject: "Science",
    description: "8-week earth sciences unit on Earth's cycles including water, rock, and carbon cycles. Students investigate how matter moves through Earth's systems and human impact on these cycles.",
    url: "/units/science-earth-Y5.html",
    weeks: 8,
    lessons: 24,
  },
  {
    id: "science-earth-Y6",
    title: "Earth Sciences — Year 6",
    yearLevel: "Year 6",
    subject: "Science",
    description: "8-week earth sciences unit on Earth's history, plate tectonics, and extreme Earth events. Students explore geological evidence, continental drift, earthquakes, volcanoes, and Earth's deep time.",
    url: "/units/science-earth-Y6.html",
    weeks: 8,
    lessons: 24,
  },
