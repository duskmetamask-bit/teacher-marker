...
const SAMPLE_UNITS: SampleUnit[] = [
  ...
  },
  {
    ...
    yearLevel: "Foundation",
    subject: "HASS",
    description: "8-week geography unit exploring places children know — home, school, neighbourhood. Uses inquiry skills: locate, explore, investigate, process, communicate.",
  ...
  },
  {
    ...
    yearLevel: "Year 1",
    subject: "HASS",
    description: "8-week geography unit examining the natural and constructed features of places. Students use photos and observations to explore their local area.",
  ...
  },
  {
    ...
    yearLevel: "Year 2",
    subject: "HASS",
    description: "8-week geography unit focusing on Aboriginal and Torres Strait Islander Country/Place. Students explore connections between people and place.",
  ...
  },
  {
    ...
    yearLevel: "Year 3",
    subject: "HASS",
    description: "8-week geography unit examining the climate and natural vegetation of places in Australia and Asia. Inquiry-based with AC9HC.",
  ...
  },
  {
    ...
    yearLevel: "Year 4",
    subject: "HASS",
    description: "8-week geography unit exploring how spaces are organised, planned, and used. Students investigate local and regional spaces and their purpose.",
  ...
  },
  {
    ...
    yearLevel: "Year 5",
    subject: "HASS",
    description: "8-week geography unit investigating the location of major countries in the Asia region and their characteristics. AC9HG.",
  ...
  },
  {
    ...
    yearLevel: "Foundation",
    subject: "Science",
    description: "8-week physical sciences unit exploring everyday movement, forces, and energy. Students investigate push and pull, shadows, and how things move.",
  ...
  },
  {
    ...
    yearLevel: "Year 1",
    subject: "Science",
    description: "8-week physical sciences unit on light and sound. Students explore how light sources work, how sound is made, and design solutions using scientific knowledge.",
  ...
  },
  {
    ...
    yearLevel: "Year 2",
    subject: "Science",
    description: "8-week physical sciences unit on energy and movement. Students investigate light, sound, heat, and how energy transfers between forms.",
